...
class Pemasukan_Page extends StatefulWidget {
  Pemasukan_Page({Key? key}) : super(key: key);

  @override
  State<Pemasukan_Page> createState() => _IncomePageState();
}

class _IncomePageState extends State<Pemasukan_Page> {
            ...
            children: [
              Container(
                ...
                child: ElevatedButton(
                  style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all<Color>(const Color.fromARGB(255, 113, 206, 206)),
